      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Ready to start your property journey? Contact us today and let our experts guide you every step of the way.
          </p>
        </div>
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                <select className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300">
                  ...
                  <option>Agent Consultation</option>
                  <option>Other</option>
                </select>
              </div>
              ...
              <button
                type="submit"
                className="w-full py-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all duration-300 font-semibold text-lg hover:shadow-lg transform hover:scale-105"
              >
                Send Message
              </button>
            </form>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@roofly.com</p>
                  </div>
                </div>
